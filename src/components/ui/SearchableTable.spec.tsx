import {createSearchRegexp, createSearchText, SearchableTable} from "@/components/ui/SearchableTable";
...
describe('SearchableTable', () => {
    ...
    test('テーブルが描画される', () => {
        const { container } = render(<SearchableTable
            headers={headers}
            items={items}
