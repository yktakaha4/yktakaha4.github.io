...
var qiitaApiGetItemsResponse_json_1 = __importDefault(require("@/services/sns/mocks/qiitaApiGetItemsResponse.json"));
...
describe('fetchItems', function () {
    ...
    test('記事が取得できる', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    (0, nock_1.default)('https://qiita.com')
                        .get('/api/v2/items')
                        .query({
                        query: "user:yktakaha4",
                        per_page: '100',
                    })
                        .reply(200, qiitaApiGetItemsResponse_json_1.default, {
                        'total-count': '2',
                    });
                    return [4 /*yield*/, (0, qiita_1.fetchItems)('yktakaha4')];
                case 1:
                    articles = _a.sent();
                    expect(articles.length).toBe(2);
                    expect(articles[0].title).toBe('Serverless FrameworkでLambdaコンテナイメージを利用する');
                    return [2 /*return*/];
            }
        });
    }); });
