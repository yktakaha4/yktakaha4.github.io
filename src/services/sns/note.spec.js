...
var noteApiGetContentsResponse_json_1 = __importDefault(require("@/services/sns/mocks/noteApiGetContentsResponse.json"));
var constants = __importStar(require("@/constants"));
var note_1 = require("@/services/sns/note");
...
describe('fetchContents', function () {
    ...
    test('記事が取得できる', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    (0, nock_1.default)('https://note.com')
                        .get('/api/v2/creators/yktakaha4/contents')
                        .query({
                        kind: 'note',
                        page: '1',
                    })
                        .reply(200, noteApiGetContentsResponse_json_1.default);
                    return [4 /*yield*/, (0, note_1.fetchContents)('yktakaha4')];
                case 1:
                    contents = _a.sent();
                    expect(contents.length).toBe(2);
                    expect(contents[0].name).toBe('新しいチームに加わるエンジニアのための "被" オンボーディングガイド v0.1.1');
                    return [2 /*return*/];
            }
        });
    }); });
});
describe('storeContents', function () {
    test('記事が保存できる', function () { return __awaiter(void 0, void 0, void 0, function () {
        var dir, mockedJsonPath, contents;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, note_1.storeContents)(contents)];
                case 1:
                    _a.sent();
