...
var buildComponentsData_1 = require("@/services/scripts/buildComponentsData");
...
describe('buildComponentsData', function () {
    test('正常に動作する', function () { return __awaiter(void 0, void 0, void 0, function () {
        var dir, techArticles, ossContributions;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    dir = (0, helper_1.tempDir)();
                    mockedGetComponentsDataPath.mockImplementation(function (name) { return "".concat(dir, "/").concat(name, ".json"); });
                    return [4 /*yield*/, (0, buildComponentsData_1.buildComponentsData)()];
                case 1:
                    _a.sent();
                    techArticles = (0, fs_extra_1.readJsonSync)("".concat(dir, "/techArticles.json"));
                    ...
                    ossContributions = (0, fs_extra_1.readJsonSync)("".concat(dir, "/ossContributions.json"));
